...
import { Box, Container, Grid, Typography, TextField, Button, Link, Paper, useTheme } from '@mui/material';
import { GitHub, LinkedIn, Mail, Phone, LocationOn, Send } from '@mui/icons-material';
...
export default function Contact() {
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      ...
      // resend to send email message to sender
