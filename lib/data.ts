...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    items: ["REST", "GraphQL", "Django", "Firebase", "Supabase"],
  },
  {
...
export const projects: Project[] = [
  {
    title: "Caroo",
    description:
      "A car auction web app in Australia that allows users to bid on and purchase vehicles.",
    image:
      "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1350&q=80", // Luxury car (verified)
  ...
  },
  {
    title: "Beauty Grail",
    description:
      "The application serves as a bridge between educators, salons, and individual learners by providing a platform for accessing and offering educational content in the hairdressing industry",
    image:
      "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=1350&q=80", // Aesthetic salon interior (verified)
  ...
  },
  {
    title: "Allied Heath",
    description:
      "Allied Health Directory is a software solution designed to facilitate seamless connections between clients and health practitioners. ",
    image:
    ...
    link: "https://web.findmytherapy.com.au/",
  },
];
